...
<h2 style="text-align:center">IDENTITY</h2>
<div class="container">
                <?php
                       include 'db1.php';
                       $link=  mysqli_connect(localhost, root, root, found);
                       $result=  mysqli_query($link, "select * from identity");
                       if(mysqli_affected_rows($link)>0)
                        {
                           ...
                           while($r=  mysqli_fetch_array($result))
                           {
                           	...
                           	if($x==0)
                               {
                               	...
                               	echo "<h2>Name On Card : $r[0]</h2>";
                                echo "<h2>Card Number : $r[1]</h2>";
                                echo "<h2>Location : $r[2]</h2>";
                               	echo "<p class='title'> Founder's Details : </p></p>";
                               	echo "<p>NAME : $r[4]</p>";
                                echo "<p>YEAR : $r[5] &nbsp &nbsp CONTACT NO. : $r[6]</p>";
                               	echo "<p>EMAIL ID : $r[7]</p>";
