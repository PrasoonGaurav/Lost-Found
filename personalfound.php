...
<head>
    <title>Lost Personal Accessory</title>
    <style type="text/css">
        * {
            padding: 0px;
            margin: 0px;
...
<body>
  ...
  <img src="foundass.png" alt="" srcset="" width="100%">
...
<div class="left">
   ...
   <!-- <input type="radio" name="Electronics" value="Mobile Phone">Mobile Phone
<input type="radio" name="Electronics" value="Laptop"> Laptop &nbsp &nbsp &nbsp &nbsp &nbsp
<input type="radio" name="Electronics" value="Electronic Accessories"> Electronic Accessories &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
<input type="radio" name="Electronics" value="Others"> Others -->

 <br>
<br>
        <form action="#" method="post">
           <!-- <b> ID <input type="text" name="pid" id="pid" placeholder="Enter Accesory ID-Eg. AB-123" />-->
            <b>Brand of the Accessory</b> &nbsp; &nbsp;  <input type="text" name="bname" id="bname" placeholder=" Eg.Puma,Casio etc" />
            <b>Colour of the Accessory</b> &nbsp; &nbsp;  <input type="text" name="cname" id="col" placeholder=" Eg. Black,Blue" />
            <b>Location Where Found</b> &nbsp; &nbsp;  <input type="text" name="loc" id="loc" placeholder=" Location" />
            <b>Others</b> &nbsp; &nbsp;  <input type="text" name="rem" id="oth" placeholder="Others" >
...
//$i=$_POST["pid"];
    ...
    $qry="insert into personal values('".$b."','".$c."','".$l."','".$r."','".$s."','".$y."','".$co."','".$e."','".$o."')"; 
