...
align:center;
	...
	align:center;
      ...
      /*  .right .loginwith {
        ...
        .picblock{
  background-image: url('foundbooks.png');
...
if(isset($_POST["btn"]))
{
    ...
    $qry="insert into books values('".$i."','".$s."','".$e."','".$c."','".$b."','".$a."','".$l."','".$n."','".$o."')"; 
    $res=mysqli_query($path,$qry);
   //$row=mysqli_fetch_array($res);
    if($res)
    {

		$msg='<br><br><br><br><center><font color="royalblue"><b>SUBMITTED SUCCESSFULLY</center></font>';
        echo $msg;
    }
    else 
    {   

     $msg='<br><br><br><br><center><font color="red"><b>PLEASE TRY AGAIN</b></font>';
	echo $msg;
	}
}
?>
