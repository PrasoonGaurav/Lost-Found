            ...
            <div class="row">
                <div class="col-sm-12" style="height:600px;width">
                    ...
                    if(isset($_POST['search']))
                    {
                        ...
                        echo "<tr>";
                        echo "<th>Book ID</th><th>Student Name</th><th>E-mail</th><th>Contact No.</th><th>Name of Book</th><th>Author's Name</th><th>Location Found</th><th>Number of Books</th><th>Remarks</th><th></th><th></th>";
                        echo "</tr>";
                        ...
                        while($row=  mysqli_fetch_array($result)) //$row returns reference of result set
                        {
                            ...
                            echo "<td>$row[7]</td>";
                            echo "<td>$row[8]</td>";
                            echo "<td><a href='deletebooks.php?id=$row[0]'>Delete</a></td>";
                            echo "</tr>";
                        }
                        echo "</table>";
                            }  
