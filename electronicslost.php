...
align:center;
	...
	align:center;
      ...
      /*  .right .loginwith {
        ...
        .picblock{
  background-image: url('photo-1524929630545-f416a20c047a.png');
...
<form action="#" method="post">
            <b> Enter Item ID  <input type="text" name="itemid" id="itemid" placeholder="Enter Item ID - Eg. MA-1234" /> 
...
if(isset($_POST["btn"]))
{
    ...
    $qry="insert into electronics values('".$i."','".$s."','".$e."','".$c."','".$b."','".$co."','".$l."','".$o."')"; 
    $res=mysqli_query($path,$qry);
    //$row=mysqli_fetch_array($res);
    if($res)
    {
        $msg='<br><br><center><font color="royalblue"><b>SUBMITTED SUCCESSFULLY</center></font>';
        echo $msg;
    }
    else 
    {
